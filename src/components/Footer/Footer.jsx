    ...
    >
      ...
      >
        <div className={css.left}>
          ...
          <span className="primaryText">
            Start by{" "}
            <a href="mailto:tanishag1717@gmail.com" className={css.link}>
              saying hi
            </a>
          </span>
        </div>
        ...
        <div className={css.right}>
          ...
          <ul className={css.menu}>
            <li>
              <a href="tel:+9871179391" className={`${css.callLink} ${css.link}`}>
            ...
            <li>
              <a
                href="mailto:tanishag1717@gmail.com"

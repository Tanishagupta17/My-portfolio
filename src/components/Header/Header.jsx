...
const Header = () => {
  ...
  const handleDownload = () => {
    const downloadUrl = '/tanisharesume1.pdf'; // Replace with the actual path to your resume file

    // Create a temporary link element
    const link = document.createElement('a');
    link.href = downloadUrl;
    link.setAttribute('download', 'tanisha-resume.pdf'); // Set the download attribute with desired file name
  ...
  return (
    ...
    >
      <div className={`innerWidth ${css.container} flexCenter`}>
        <div className={css.name}>Tanisha</div>
